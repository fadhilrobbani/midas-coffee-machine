...
| :--- | :--- | :--- |
| **Average Cup Height** | **7.78 cm** | Mean of all valid predictions. |
| **Median Height (P50)** | **7.79 cm** | Most representative single value. |
| **Precision Error (P95−P5)** | **0.28 cm** | 90% of readings fall within this range. |
| **Standard Deviation ($\sigma$)** | 0.09 cm | Consistency / jitter of the AI model. |
| **Tray Anchor Depth (Z)** | 26.08 cm | Average physical depth of the tray. |
| **Minimum / Maximum Height** | 7.55 / 7.99 cm | Extremes recorded. |
| **Total Frames / Inferences** | 28 / 28 | Pipeline tracking efficiency. |
