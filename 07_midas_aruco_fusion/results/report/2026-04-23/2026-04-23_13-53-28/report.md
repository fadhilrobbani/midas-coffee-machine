...
| **Median Height (P50)** | **7.03 cm** | Most representative single value. |
| **Precision Error (P95−P5)** | **0.75 cm** | 90% of readings fall within this range. |
| **Standard Deviation ($\sigma$)** | 0.27 cm | Consistency / jitter of the AI model. |
| **Tray Anchor Depth (Z)** | 21.35 cm | Average physical depth of the tray. |
| **Minimum / Maximum Height** | 6.75 / 7.69 cm | Extremes recorded. |
| **Total Frames / Inferences** | 18 / 13 | Pipeline tracking efficiency. |
