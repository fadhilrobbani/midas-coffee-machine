...
| :--- | :--- | :--- |
| **Average Cup Height** | **7.45 cm** | Mean of all valid predictions. |
| **Median Height (P50)** | **7.53 cm** | Most representative single value. |
...
| **Tray Anchor Depth (Z)** | 23.81 cm | Average physical depth of the tray. |
| **Minimum / Maximum Height** | 6.92 / 7.83 cm | Extremes recorded. |
| **Total Frames / Inferences** | 879 / 197 | Pipeline tracking efficiency. |
