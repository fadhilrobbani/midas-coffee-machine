...
| :--- | :--- | :--- |
| **Average Cup Height** | **8.78 cm** | Mean of all valid predictions. |
| **Median Height (P50)** | **8.78 cm** | Most representative single value. |
| **Precision Error (P95−P5)** | **0.17 cm** | 90% of readings fall within this range. |
| **Standard Deviation ($\sigma$)** | 0.06 cm | Consistency / jitter of the AI model. |
| **Tray Anchor Depth (Z)** | 21.57 cm | Average physical depth of the tray. |
| **Minimum / Maximum Height** | 8.67 / 8.88 cm | Extremes recorded. |
| **Total Frames / Inferences** | 114 / 110 | Pipeline tracking efficiency. |
