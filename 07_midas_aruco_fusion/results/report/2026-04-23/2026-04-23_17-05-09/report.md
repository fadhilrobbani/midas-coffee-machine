...
| :--- | :--- | :--- |
| **Average Cup Height** | **7.39 cm** | Mean of all valid predictions. |
| **Median Height (P50)** | **7.41 cm** | Most representative single value. |
| **Precision Error (P95−P5)** | **0.62 cm** | 90% of readings fall within this range. |
| **Standard Deviation ($\sigma$)** | 0.22 cm | Consistency / jitter of the AI model. |
| **Tray Anchor Depth (Z)** | 23.34 cm | Average physical depth of the tray. |
| **Minimum / Maximum Height** | 6.13 / 8.72 cm | Extremes recorded. |
| **Total Frames / Inferences** | 742 / 199 | Pipeline tracking efficiency. |
